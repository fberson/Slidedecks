...
resource saaib 'Microsoft.Storage/storageAccounts@2023-01-01' = {
...
resource fssofwtare 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  name: filesharelocation1
}
resource fsscripts 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  name: filesharelocation2
}

//Create Storage account 2
resource saprof 'Microsoft.Storage/storageAccounts@2023-01-01' = {
...
resource fsprofiles 'Microsoft.Storage/storageAccounts/fileServices/shares@2023-01-01' ={
