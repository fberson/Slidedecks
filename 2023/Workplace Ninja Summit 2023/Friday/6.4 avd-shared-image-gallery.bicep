...
resource AVDsig 'Microsoft.Compute/galleries@2022-03-03' = {
  name: sigName
  location: sigLocation
}

//create role definition
resource gallerydef 'Microsoft.Authorization/roleDefinitions@2022-05-01-preview' = {
...
resource galleryass 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
