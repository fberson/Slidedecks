...
$MSIXSourceLocation = "C:\MSIX\2.MSIX\"
$MSIXAppAttachDestinationPath = "C:\MSIX\3.AppAttach\"
$MSIXSourceFiles = @("SpeedtestbyOokla_1.13.194.0_x64__g33wvrk220n28.msix")
$MSIXappattachContainerSizeMb = 250MB
$MSIXappattachContainerLabel = "speedtest"
$MSIXappattachContainerRootFolder = "speedtest"
